                   ...
                   <ul class="tc _o sf yo cg ep">
                       ...
                       <li class="c i" x-data="{ dropdown: false }">
                           ...
                           <ul class="a" :class="{ 'tc': dropdown }">
                               <li><a href="signin.html" class="xl" :class="{ 'mk': page === 'signin' }">Iniciar
                                       Sesion</a></li>
                               <li><a href="signup.html" class="xl"
                                       :class="{ 'mk': page === 'signup' }">Registrarse</a></li>
                           </ul>
                           <!-- Dropdown End -->
                       </li>
                   </ul>
               ...
               <div class="tc wf ig pb no">
                   <div class="pc h io pa ra" :class="navigationOpen ? '!-ud-visible' : 'd'">
                       <label class="rc ab i">
                           ...
                           <!-- Icon Sun -->
                           <svg :class="{ 'mk': page === 'home', 'xh': page === 'home' && stickyMenu }" class="th om"
                           ...
                           <!-- Icon Sun -->
                           <img class="xc nm mk" src="{{asset('images/icon-moon.svg')}}" alt="Moon" />
                       </label>
                   </div>
                   ...
                   @if (Route::has('login'))
                       @auth
                           <a href="{{ url('/dashboard') }}"
                               :class="{ 'mk': page === 'home', 'ok': page === 'home' && stickyMenu }"
                               class="ek pk xl mk">Dashboard</a>
                       @else
                           <a href="{{ route('login') }}"
                               :class="{ 'mk': page === 'home', 'ok': page === 'home' && stickyMenu }"
                               class="ek pk xl mk">Iniciar Sesion</a>

                           @if (Route::has('register'))
                               <a href="{{ route('register') }}"
                                   :class="{ 'mk': page === 'home', 'ok': page === 'home' && stickyMenu }"
                                   class="ek pk xl mk">Registrarse</a>
                           @endif
                       @endauth
                   @endif
               </div>
