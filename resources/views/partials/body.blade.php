    ...
    <div class="bb ze ki xn 2xl:ud-px-0">
        <div class="tc _o">
            <div class="jn/2">
                ...
                <p class="fq">
                    Si buscas vuelos para tu próxima aventura, los encontrarás en BIT, ya sea para disfrutar de unas
                    merecidas vacaciones, una escapada de fin de semana o para hacer ese importante viaje de negocios
...
<section class="ji gp uq">
    <!-- Section Title Start -->
    <div
        x-data="{ sectionTitle: `Top destinos más buscados hoy en México`, sectionTitleText: `Escoge el mejor vuelo para tu próxima aventura` }">
